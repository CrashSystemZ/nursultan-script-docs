...
| `slots.hold(hotbarSlot)` | `HeldSlot` | переиспользует живую ручку, если слот уже выбран, иначе выбирает его (только главный поток) |
| `slots.selected()` | `Slot` | слот хотбара, выбранный прямо сейчас |
...
| `holding()` | `boolean` | этот слот всё ещё выбран и ручка не израсходована |
